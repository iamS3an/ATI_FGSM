...
for eps in [0.05, 0.1, 0.01, 0.02]:
    train = pd.read_csv(f'./atk_eval_doneATI/{eps}/train.csv', header=0, sep=',', comment='#', low_memory=False)
    test = pd.read_csv(f'./atk_eval_doneATI/{eps}/pvalue_test.csv', header=0, comment='#', low_memory=False)
